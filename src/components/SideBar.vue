...
<template>
    ...
    <div id="drawer-right-example" class="fixed z-50 h-screen p-4 overflow-y-hidden bg-white w-72 dark:bg-gray-800 "
        ...
        <h5 id="drawer-right-label"
            ...
            </svg><span class="ml-3 ">SETTINGS</span></h5>
        ...
        <div id="drawer-disable-body-scrolling"
            class="fixed z-40 w-64 h-screen p-4 overflow-y-auto bg-white border-t border-gray-200 dark:bg-gray-800 dark:border-gray-700"
            ...
            <div class="py-4 overflow-y-auto">
                <ul class="space-y-2">
                    <li>
                        <a href="#"
                            ...
                            <button id="theme-toggle" type="button"
                                class="text-sm text-gray-500 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-700 ">
                            ...
                            </button> <span class="ml-3">Light / Dark</span>
                        </a>
                    </li>
                    ...
                    <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-emerald-100 dark:bg-gray-900" role="alert">
                        <div class="flex items-center mb-3">
                            <span
                                class="bg-emerald-300 text-gray-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-emerald-500 dark:text-gray-900">Beta</span>
                            <button type="button"
                                class="ml-auto -mx-1.5 -my-1.5 bg-emerald-300 text-blue-900 rounded-lg focus:ring-2 focus:ring-blue-400 p-1 hover:bg-blue-200 inline-flex h-6 w-6 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-emerald-500 dark:hover:text-gray-900"
                        ...
                        <p class="mb-3 text-sm text-emerald-900 dark:text-gray-100">
                            The Portfolio you are viewing is currently under Developing by Mike Gester. If you want to
                            have
                            you own website kindly message me in the link below.
                        </p>
    ...
    <aside class="fixed top-0 left-0 z-50 w-64 h-full" aria-label="Sidenav">
        <div
            ...
            <a href="https://flowbite.com/" class="flex items-center pl-2.5 mb-5">
                <img src="../assets/imgs/my-logo.png" class="h-6 mr-3 -ml-1 sm:h-7" alt="Mike Gester Logo" />
                <span class="self-center text-xl font-semibold text-gray-400 whitespace-nowrap dark:text-gray-400">My
                    Portfolio</span>
            </a>
            <ul class="space-y-2">
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base font-normal text-gray-400 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700"
                        aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                        <svg aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-emerald-500 dark:group-hover:text-white dark:hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z">
                            </path>
                        </svg>
                        <span class="flex-1 ml-3 text-left hover:text-emerald-500 whitespace-nowrap">Overview</span>
                        <svg aria-hidden="true" class="w-6 h-6 group-hover:text-emerald-500" fill="currentColor"
                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/projects"
                                ...
                                </svg><span class="ml-3">Projects</span></a>
                        </li>
                        <li>
                            <a href="#"
                                ...
                                <svg class="w-6 h-6 text-gray-400 group-hover:text-emerald-500" fill="currentColor"
                                    ...
                                    <path fill-rule="evenodd"
                                        ...
                                        clip-rule="evenodd"></path>
                                </svg><span class="ml-3">Gallery</span></a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-400 hover:text-emerald-500 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400  dark:hover:bg-gray-700"><svg
                                    ...
                                    <path fill-rule="evenodd"
                                        ...
                                        clip-rule="evenodd"></path>
                                </svg><span class="ml-3">Videos</span></a>
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-400  dark:hover:bg-gray-700"
                    ...
                    <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400  dark:hover:bg-gray-700"><svg
                                    class="w-7 h-7 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 2h10v7h-2l-1 2H8l-1-2H5V5z"
                                        clip-rule="evenodd"></path>
                                </svg><span class="ml-3">Fish & Aquarium Supplies</span></a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-400  dark:hover:bg-gray-700"><svg
                                    class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                </svg><span class="ml-3">Pasabike</span></a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  dark:hover:text-white dark:text-gray-400  dark:hover:bg-gray-700"><svg
                                    class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z"
                                        clip-rule="evenodd"></path>
                                </svg><span class="ml-3">Personal Website Design</span></a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-gray-400  dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <span
                            class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-emerald-700 dark:text-gray-300">Soon</span>
                    </a>
                </li>
            ...
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700  dark:hover:text-white dark:text-gray-400 group">
                        <svg aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-400 dark:hover:text-white dark:group-hover:text-white">
